...
// Added in sync schema 6 (the exame-particular temas). Same rule again:
// schema-≤5 snapshots lack this key entirely; validateSyncState allows it missing.
export const EXAME_TABLES = ['exameTemas']
